package com.board.novaapi.OAuth.handler;
...
import com.board.novaapi.OAuth.token.AuthToken;
...
import static com.board.novaapi.OAuth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static com.board.novaapi.OAuth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        RoleType roleType ;
        // 권한 확인시 ADMIN, USER 권한을 보유하고 있지 않다면 GUEST 권한으로 부여
        if(hasAuthority(authorities,RoleType.ADMIN.getCode())){
            roleType = RoleType.ADMIN;
        }
        else if(hasAuthority(authorities,RoleType.USER.getCode())){
