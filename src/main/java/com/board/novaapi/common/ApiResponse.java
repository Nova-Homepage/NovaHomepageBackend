package com.board.novaapi.common;
...
public class ApiResponse<T> {
    ...
    private final static String INVALID_ACCESS_TOKEN = "유효하지 않은 ACCESS 토큰 입니다";
    private final static String INVALID_REFRESH_TOKEN = "유효하지 않은 REFRESH 토큰 입니다";
